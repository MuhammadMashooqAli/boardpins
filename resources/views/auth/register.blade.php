                                       ...
                                       <div class="row">
                                          ...
                                          <div class="col-md-6">
                                             <div class="register-page-form">
                                                <form class="rwmb-form mbup-form"  action="{{ route('register') }}" method="post" enctype="multipart/form-data" id="login-form">
                                                   @csrf  
                                                   <div class="ctrlbp-field ctrlbp-row ctrlbp-text-wrapper  required ctrlbp-field-has-label">
                                                      <div class="ctrlbp-label ctrlbp-col-12 ctrlbp-col-md-3">
                                                         <label for="user_login">First Name<span class="ctrlbp-required">*</span></label>
                                                      </div>
                                                      <div class="ctrlbp-input ctrlbp-col-12 ctrlbp-col-md-12">
                                                         <input  type="text" placeholder="Enter First Name" name="first_name" value="{{ old('first_name') }}" required class="ctrlbp-text form-control @error('first_name') is-invalid @enderror">
                                                         @error('first_name')
                                                   ...
                                                   <div class="ctrlbp-field ctrlbp-row ctrlbp-text-wrapper  required ctrlbp-field-has-label">
                                                      <div class="ctrlbp-label ctrlbp-col-12 ctrlbp-col-md-3">
                                                         <label for="user_login">Last Name<span class="ctrlbp-required">*</span></label>
                                                      </div>
                                                      <div class="ctrlbp-input ctrlbp-col-12 ctrlbp-col-md-12">
                                                         <input  type="text" placeholder="Enter Last Name" name="last_name" value="{{ old('last_name') }}" required class="ctrlbp-text form-control @error('last_name') is-invalid @enderror">
                                                         @error('last_name')
                                                         <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                         </span>
                                                   ...
                                                   <div class="ctrlbp-field ctrlbp-row ctrlbp-text-wrapper  required ctrlbp-field-has-label">
                                                      <div class="ctrlbp-label ctrlbp-col-12 ctrlbp-col-md-3">
                                                         <label for="user_login">Email Address<span class="ctrlbp-required">*</span></label>
                                                      </div>
                                                      <div class="ctrlbp-input ctrlbp-col-12 ctrlbp-col-md-12">
