    ...
    <div class="wsmainfull menu clearfix ">
      <div class="wsmainwp  clearfix">
        ...
        <div class="desktoplogo">
           <a href="{{url('/')}}" class="logo-black">
              <img src="{{logoUrl()}}" alt="Martex &#8211;  Landing Page" width="163" />      </a>

 <a href="{{url('/')}}" class="logo-white">
  
              <img src="@if(request()->route()->getName() != 'mainIndex') {{logoUrl()}} @else  {{logoWhiteUrl()}} @endif" alt="Martex &#8211;  Landing Page" width="163" />      </a>        </div>
...
<ul class="sub-menu martex-menu">
	...
	<li id="menu-item-668" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-668"><a href="{{url('/profile')}}" class="h-link">Profile</a></li>
</ul>
</li>
...
@else
<li class="nl-simple reg-fst-link mobile-last-link">
    <a class="h-link" href="{{url('/home')}}">Dashboard&nbsp;&nbsp;&nbsp;<span class="wsarrow"></span></a>
    <ul class="sub-menu martex-menu">
       <li id="menu-item-68" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-682">
       <a class="h-link" href="{{ route('logout') }}"
